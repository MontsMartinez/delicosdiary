...
export const datosUnidades = {
  ...
  2: {
    ...
    comicPanels: [ 
      {
        id: 1,
        imageSrc: "/assets/images/comic/u2_panel1.png", 
        altText: "Despertando por la mañana",
        hoverTextCoreano: "아침 일곱 시에 일어나요.",
        textPosition: "bottom",
        layoutClass: "panel-normal", // Panel 1 (Página 1, arriba-izquierda)
      },
      {
        id: 2,
        imageSrc: "/assets/images/comic/u2_panel2.png",
        altText: "Tomando café",
        hoverTextCoreano: "커피를 마셔요. 그리고 빵을 먹어요.",
        textPosition: "top",
        layoutClass: "panel-normal", // Panel 2 (Página 1, arriba-derecha)
      },
      {
        id: 3,
        imageSrc: "/assets/images/comic/u2_panel3.png",
        altText: "Yendo a la universidad",
        hoverTextCoreano: "오전 아홉 시에 학교에 가요.",
        textPosition: "bottom",
        layoutClass: "panel-wide", // Panel 3 (Página 1, abajo, ancho)
      },
      {
        id: 4,
        imageSrc: "/assets/images/comic/u2_panel4.png",
        altText: "Estudiando en la biblioteca",
        hoverTextCoreano: "도서관에서 한국어를 공부해요.",
        textPosition: "top",
        layoutClass: "panel-tall", // Panel 4 (Página 2, izquierda, alto)
      },
      {
        id: 5,
        imageSrc: "/assets/images/comic/u2_panel5.png",
        altText: "Almorzando con amigos",
        hoverTextCoreano: "점심에 친구하고 식당에 가요. 비빔밥을 먹어요.",
        textPosition: "bottom",
        layoutClass: "panel-normal", // Panel 5 (Página 2, arriba-derecha)
      },
      {
        id: 6,
        imageSrc: "/assets/images/comic/u2_panel6.png",
        altText: "Volviendo a casa por la tarde",
        hoverTextCoreano: "오후 다섯 시에 집에 와요.",
        textPosition: "top",
        layoutClass: "panel-normal", // Panel 6 (Página 2, abajo-derecha)
      }
      // Puedes añadir más paneles y ajustar la lógica de división en Unidad2.jsx si es necesario
    ],
  },
  3: {
    isBookPage: false,
